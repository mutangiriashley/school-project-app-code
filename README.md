...
I made the application come pre-seeded with a default user account for testing the login flow immediately:
* **Email:** `ashleymutangiri@gmail.com`
* **Password:** `12345`

## 🚀 Getting Started

The project is built with Android Studio using standard Android Gradle tooling. To build and run:
